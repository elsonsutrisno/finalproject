...
def is_within_restricted_range(booked_suggestion_time, current_hour):
    return (
        ...
        or (time(11, 0, 0) <= booked_suggestion_time <= time(14, 0, 0) and current_hour <= time(14, 0, 0) or current_hour > time(9, 0, 0))
        or (time(17, 0, 0) <= booked_suggestion_time <= time(19, 30, 0) and current_hour <= time(19, 30, 0) or current_hour > time(14, 0, 0))
    )
...
def get_current_hour_and_current_date():
    ...
    if time(14, 0, 0) <= current_hour <= time(17, 0, 0):
